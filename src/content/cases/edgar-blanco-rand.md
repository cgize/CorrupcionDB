---
implicado: Edgar Blanco Rand
cargo: Intendente de la Región de Antofagasta
caso:
  id: caso-canastas
  nombre: Caso Canastas
coimplicados:
- Pablo Ormeño Fredes
partido: RN
region: Antofagasta
delito: fraude_al_fisco
monto: $4.000 millones de pesos en compras directas de canastas de alimentos y mascarillas durante la pandemia
monto_clp: 4000000000
estado: investigation
tipo_proceso: investigacion_reservada
fuente: CIPER Chile
fuente_url: https://www.ciperchile.cl/2021/01/23/los-cuestionados-vinculos-de-empresas-contratadas-en-antofagasta/
fuente_tipo: investigacion
fuentes_adicionales:
- nombre: El Diario de Antofagasta - Caso Canastas
  url: https://www.diarioantofagasta.cl/investigacion/198120/caso-canastas-las-claves-del-que-podria-ser-uno-de-los-mayores-casos-de-corrupcion-en-la-historia-reciente-de-antofagasta/
  tipo: prensa
- nombre: Wikipedia - Edgar Blanco
  url: https://es.wikipedia.org/wiki/Edgar_Blanco
  tipo: prensa
periodistas:
- Alejandro Ahumada
- Cristian Ascencio
...
- renovacion-nacional
- compras-publicas
fiscalia: Fiscalía Regional de Antofagasta
hitos:
- fecha: 2020-03-25
  titulo: Creación de Limpieza Industrial SpA
  descripcion: Se constituye la empresa Limpieza Industrial SpA, propiedad de Pablo Ormeño, amigo del intendente Edgar Blanco.
  tipo: investigacion
- fecha: 2020-04-06
  titulo: Adjudicación de contrato por $1.648 millones
  descripcion: El Servicio de Salud de Antofagasta adjudica a Limpieza Industrial la compra de mascarillas por $1.648 millones.
  tipo: otro
- fecha: 2020-05-01
  titulo: Contratos por canastas de alimentos
  descripcion: La Intendencia Regional adjudica a EDS JCM Spa y Need Solutions la compra de 40 mil canastas familiares por $1.665 millones.
  tipo: otro
- fecha: 2021-01-23
  titulo: Publicación de investigación de CIPER
  descripcion: CIPER publica investigación revelando los cuestionados vínculos de empresas contratadas en Antofagasta.
  tipo: investigacion
- fecha: 2024-08-01
  titulo: Reapertura de investigación
  descripcion: El Juzgado de Garantía de Antofagasta ordena reabrir la investigación del Caso Canastas.
  tipo: resolucion
- fecha: 2024-09-21
  titulo: Incautación del celular de Edgar Blanco
  descripcion: La PDI incauta documentos y el celular del ex intendente Edgar Blanco como parte de las nuevas diligencias.
  tipo: allanamiento
---
